    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="yishengId" name="yishengId" type="hidden">
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="医生预约编号" prop="yishengYuyueUuidNumber">
                       <el-input v-model="ruleForm.yishengYuyueUuidNumber"
                                 placeholder="医生预约编号" clearable  :readonly="ro.yishengYuyueUuidNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="医生预约编号" prop="yishengYuyueUuidNumber">
                           <el-input v-model="ruleForm.yishengYuyueUuidNumber"
                                     placeholder="医生预约编号" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="预约标题" prop="yishengYuyueName">
                       <el-input v-model="ruleForm.yishengYuyueName"
                                 placeholder="预约标题" clearable  :readonly="ro.yishengYuyueName"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="预约标题" prop="yishengYuyueName">
                           <el-input v-model="ruleForm.yishengYuyueName"
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="预约类型" prop="yishengYuyueTypes">
                        <el-select v-model="ruleForm.yishengYuyueTypes" :disabled="ro.yishengYuyueTypes" placeholder="请选择预约类型">
                            <el-option
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="预约类型" prop="yishengYuyueValue">
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info' && !ro.yishengYuyueContent"  label="预约内容" prop="yishengYuyueContent">
                        <editor style="min-width: 200px; max-width: 600px;"
                                v-model="ruleForm.yishengYuyueContent"
                                class="editor"
                                action="file/upload">
                        </editor>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.yishengYuyueContent" label="预约内容" prop="yishengYuyueContent">
                            <span v-html="ruleForm.yishengYuyueContent"></span>
                        </el-form-item>
                    </div>
                </el-col>
        ...
        data() {
            return {
                ...
                ro:{
                    ...
                    yishengYuyueName: false,
                    yishengYuyueTypes: false,
                    yishengYuyueTime: false,
                    yishengYuyueContent: false,
                ...
                rules: {
                   ...
                   yishengYuyueUuidNumber: [
                              { required: true, message: '医生预约编号不能为空', trigger: 'blur' },
                          ],
                   yishengYuyueName: [
