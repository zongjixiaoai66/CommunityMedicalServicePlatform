    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="yishengId" name="yishengId" type="hidden">
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="居民就诊编号" prop="jiuzhenUuidNumber">
                       <el-input v-model="ruleForm.jiuzhenUuidNumber"
                                 placeholder="居民就诊编号" clearable  :readonly="ro.jiuzhenUuidNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="居民就诊编号" prop="jiuzhenUuidNumber">
                           <el-input v-model="ruleForm.jiuzhenUuidNumber"
                                     placeholder="居民就诊编号" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
                <el-col :span="24">
                    <el-form-item v-if="type!='info' && !ro.zhusuContent"  label="主诉" prop="zhusuContent">
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info' && !ro.xianbingshiContent"  label="现病史" prop="xianbingshiContent">
                        <editor style="min-width: 200px; max-width: 600px;"
                                v-model="ruleForm.xianbingshiContent"
                                class="editor"
                                action="file/upload">
                        </editor>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.xianbingshiContent" label="现病史" prop="xianbingshiContent">
                            <span v-html="ruleForm.xianbingshiContent"></span>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="24">
                    <el-form-item v-if="type!='info' && !ro.tigejianchaContent"  label="体格检查" prop="tigejianchaContent">
                        <editor style="min-width: 200px; max-width: 600px;"
                                v-model="ruleForm.tigejianchaContent"
                                class="editor"
                                action="file/upload">
                        </editor>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.tigejianchaContent" label="体格检查" prop="tigejianchaContent">
                            <span v-html="ruleForm.tigejianchaContent"></span>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="24">
                    <el-form-item v-if="type!='info' && !ro.zhenduanjieguoContent"  label="诊断结果" prop="zhenduanjieguoContent">
                        <editor style="min-width: 200px; max-width: 600px;"
                                v-model="ruleForm.zhenduanjieguoContent"
                                class="editor"
                                action="file/upload">
                        </editor>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.zhenduanjieguoContent" label="诊断结果" prop="zhenduanjieguoContent">
                            <span v-html="ruleForm.zhenduanjieguoContent"></span>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="24">
                    <el-form-item v-if="type!='info' && !ro.chuliyijianContent"  label="处理意见" prop="chuliyijianContent">
                        <editor style="min-width: 200px; max-width: 600px;"
                                v-model="ruleForm.chuliyijianContent"
                                class="editor"
                                action="file/upload">
                        </editor>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.chuliyijianContent" label="处理意见" prop="chuliyijianContent">
                            <span v-html="ruleForm.chuliyijianContent"></span>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12">
                    <el-form-item v-if="type!='info'"  class="input" label="就诊时间" prop="jiuzhenTime">
                        <el-date-picker
                                value-format="yyyy-MM-dd HH:mm:ss"
                                v-model="ruleForm.jiuzhenTime"
                                type="datetime"
                                placeholder="就诊时间"
                                :disabled="ro.jiuzhenTime">
                        </el-date-picker>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.jiuzhenTime" label="就诊时间" prop="jiuzhenTime">
                            <span v-html="ruleForm.jiuzhenTime"></span>
                        </el-form-item>
                    </div>
                </el-col>
        ...
        data() {
            return {
                ...
                ro:{
                    yonghuId: false,
                    yishengId: false,
                    jiuzhenUuidNumber: false,
                    zhusuContent: false,
                    xianbingshiContent: false,
                    tigejianchaContent: false,
                    zhenduanjieguoContent: false,
                    chuliyijianContent: false,
                    jiuzhenTime: false,
                    insertTime: false,
                },
                ruleForm: {
                    yonghuId: '',
                    yishengId: '',
                    jiuzhenUuidNumber: new Date().getTime(),
                    zhusuContent: '',
                    xianbingshiContent: '',
                    tigejianchaContent: '',
                    zhenduanjieguoContent: '',
                    chuliyijianContent: '',
                    jiuzhenTime: '',
                    insertTime: '',
                },
                ...
                rules: {
                   ...
                   jiuzhenUuidNumber: [
                              { required: true, message: '居民就诊编号不能为空', trigger: 'blur' },
                          ],
                   zhusuContent: [
