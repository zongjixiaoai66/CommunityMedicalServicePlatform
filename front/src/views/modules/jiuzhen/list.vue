        ...
        <div v-if="showFlag">
            <el-form :inline="true" :model="searchForm" class="form-content">
                <el-row :gutter="20" class="slt" :style="{justifyContent:contents.searchBoxPosition=='1'?'flex-start':contents.searchBoxPosition=='2'?'center':'flex-end'}">
                     ...
                     <el-form-item :label="contents.inputTitle == 1 ? '居民就诊编号' : ''">
                         <el-input prefix-icon="el-icon-search" v-model="searchForm.jiuzhenUuidNumber" placeholder="居民就诊编号" clearable></el-input>
                     </el-form-item>
                ...
                <el-row class="ad" :style="{justifyContent:contents.btnAdAllBoxPosition=='1'?'flex-start':contents.btnAdAllBoxPosition=='2'?'center':'flex-end'}">
                    <el-form-item>
                        ...
                        <a style="text-decoration:none" class="el-button el-button--success"
                           ...
                           href="http://localhost:8080/yiliaozonghefuwu/upload/jiuzhenMuBan.xls"
                        >批量导入居民就诊数据模板</a>
                        &nbsp;
                        <el-upload
                                v-if="isAuth('jiuzhen','导入导出')"
            ...
            <div class="table-content">
                <el-table class="tables" :size="contents.tableSize" :show-header="contents.tableShowHeader"
                    ...
                    <el-table-column  :sortable="contents.tableSortable" :align="contents.tableAlign"
                                   prop="jiuzhenUuidNumber"
                                   header-align="center"
                                   label="居民就诊编号">
                        <template slot-scope="scope">
                            {{scope.row.jiuzhenUuidNumber}}
                        </template>
                    </el-table-column>
...
<script>
    ...
    //当前表下拉框搜索条件
            form:{
                ...
                yonghuId : null,
                yishengId : null,
                jiuzhenUuidNumber : null,
                zhusuContent : null,
                xianbingshiContent : null,
                tigejianchaContent : null,
                zhenduanjieguoContent : null,
                chuliyijianContent : null,
                jiuzhenTime : null,
                insertTime : null,
                createTime : null,
            },
        ...
        methods: {
            ...
            getDataList() {
                ...
                if (this.searchForm.jiuzhenUuidNumber!= '' && this.searchForm.jiuzhenUuidNumber!= undefined) {
                    params['jiuzhenUuidNumber'] = '%' + this.searchForm.jiuzhenUuidNumber + '%'
                }
