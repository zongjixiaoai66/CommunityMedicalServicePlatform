                ...
                <el-row :gutter="20" class="slt" :style="{justifyContent:contents.searchBoxPosition=='1'?'flex-start':contents.searchBoxPosition=='2'?'center':'flex-end'}">
                    ...
                    <el-form-item :label="contents.inputTitle == 1 ? '开始测量日期' : ''">
                        <el-date-picker
                                ...
                                v-model="searchForm.celiangTimeStartSearch"
                                type="date"
                                placeholder="开始时间">
                        </el-date-picker>
                    </el-form-item>
                    ...
                    <el-form-item :label="contents.inputTitle == 1 ? '结束测量日期' : ''">
                        <el-date-picker
                                value-format="yyyy-MM-dd"
                                v-model="searchForm.celiangTimeEndSearch"
                                type="date"
                                placeholder="结束时间">
                        </el-date-picker>
                    </el-form-item>
                ...
                <el-row class="ad" :style="{justifyContent:contents.btnAdAllBoxPosition=='1'?'flex-start':contents.btnAdAllBoxPosition=='2'?'center':'flex-end'}">
                    <el-form-item>
                        ...
                        <a style="text-decoration:none" class="el-button el-button--success"
                           ...
                           href="http://localhost:8080/yiliaozonghefuwu/upload/jiankangMuBan.xls"
                        >批量导入居民健康信息数据模板</a>
                        &nbsp;
                        <el-upload
                                v-if="isAuth('jiankang','导入导出')"
    ...
    //当前表下拉框搜索条件
        ...
        methods: {
            ...
            getDataList() {
                ...
                if (this.searchForm.celiangTimeStartSearch != '' && this.searchForm.celiangTimeStartSearch != undefined) {
                    params['celiangTimeStart'] = this.searchForm.celiangTimeStartSearch
                }
                if (this.searchForm.celiangTimeEndSearch != '' && this.searchForm.celiangTimeEndSearch != undefined) {
                    params['celiangTimeEnd'] = this.searchForm.celiangTimeEndSearch
                }
