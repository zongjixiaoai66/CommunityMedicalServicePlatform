    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="血氧" prop="xueyang">
                       <el-input v-model="ruleForm.xueyang"
                                 placeholder="血氧" clearable  :readonly="ro.xueyang"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="血氧" prop="xueyang">
                           <el-input v-model="ruleForm.xueyang"
                                     placeholder="血氧" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="脉搏" prop="maibo">
                       <el-input v-model="ruleForm.maibo"
                                 placeholder="脉搏" clearable  :readonly="ro.maibo"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="脉搏" prop="maibo">
                           <el-input v-model="ruleForm.maibo"
                                     placeholder="脉搏" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
                <el-col :span="12">
                    <el-form-item v-if="type!='info'"  class="input" label="测量日期" prop="celiangTime">
                        <el-date-picker
                                value-format="yyyy-MM-dd"
                                v-model="ruleForm.celiangTime"
                                type="date"
                                placeholder="测量日期"
                                :disabled="ro.celiangTime">
                        </el-date-picker>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.celiangTime" label="测量日期" prop="celiangTime">
                            <span v-html="ruleForm.celiangTime"></span>
                        </el-form-item>
                    </div>
                </el-col>

                <el-col :span="24">
                    <el-form-item v-if="type!='info' && !ro.jiankangContent"  label="备注" prop="jiankangContent">
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.jiankangContent" label="备注" prop="jiankangContent">
        ...
        data() {
            return {
                ...
                rules: {
                   ...
                   xintiao: [
                              { required: true, message: '心跳不能为空', trigger: 'blur' },
                   ...
                   xueyang: [
                              { required: true, message: '血氧不能为空', trigger: 'blur' },
                              {  pattern: /^[0-9]{0,6}(\.[0-9]{1,2})?$/,
                                  message: '只允许输入整数6位,小数2位的数字',
                                  trigger: 'blur'
                              }
