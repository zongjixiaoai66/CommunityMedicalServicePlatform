    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="医保编号" prop="yibaoUuidNumber">
                       <el-input v-model="ruleForm.yibaoUuidNumber"
                                 placeholder="医保编号" clearable  :readonly="ro.yibaoUuidNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="医保编号" prop="yibaoUuidNumber">
                           <el-input v-model="ruleForm.yibaoUuidNumber"
                                     placeholder="医保编号" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
                <el-col :span="12">
                ...
                <el-col :span="12">
                    <el-form-item v-if="type!='info'"  class="input" label="医保到期日期" prop="yibaoTime">
                        <el-date-picker
                                value-format="yyyy-MM-dd"
                                v-model="ruleForm.yibaoTime"
                                type="date"
                                placeholder="医保到期日期"
                                :disabled="ro.yibaoTime">
                        </el-date-picker>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.yibaoTime" label="医保到期日期" prop="yibaoTime">
                            <span v-html="ruleForm.yibaoTime"></span>
                        </el-form-item>
                    </div>
                </el-col>

                <el-col :span="24">
                    <el-form-item v-if="type!='info' && !ro.yibaoContent"  label="医保备注" prop="yibaoContent">
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.yibaoContent" label="医保备注" prop="yibaoContent">
        ...
        data() {
            return {
                ...
                rules: {
                   ...
                   yibaoUuidNumber: [
                              { required: true, message: '医保编号不能为空', trigger: 'blur' },
                          ],
                   yibaoTypes: [
                   ...
                   yibaoTime: [
                              { required: true, message: '医保到期日期不能为空', trigger: 'blur' },
                          ],
                   yibaoContent: [
                              { required: true, message: '医保备注不能为空', trigger: 'blur' },
                          ],
                   insertTime: [
